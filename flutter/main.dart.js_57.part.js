...
var y={k:A.E("fy"),h:A.E("e6"),e:A.E("ty"),y:A.E("a5<f,@>"),u:A.E("by<fy>"),w:A.E("f"),b:A.E("@"),d:A.E("y<@>?")};(function constants(){C.te=new B.ty("1",0,"novel")
C.tf=new B.ty("2",1,"single")
C.Es=new A.bA([C.te,"1",C.tf,"2"],A.E("bA<ty,f>"))})();(function lazyInitializers(){var x=a.lazyFinal
x($,"bnu","b1X",()=>A.cI("/forum/page"))
x($,"bnq","aTk",()=>A.cI("/forum/collection"))
x($,"bnr","b1V",()=>A.cI("/forum/collection/page"))
x($,"bns","b1W",()=>A.cI("/forum/detail"))
x($,"bnt","NL",()=>new B.SW())})()}
$__dart_deferred_initializers__["jGyx324mvZu25QRzsVtzmFU4TJA="] = $__dart_deferred_initializers__.current
